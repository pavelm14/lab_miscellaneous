...
#######################################################
# Run the unconstrained DEC model
#######################################################
...
# For a slow analysis, run once with TRUE
# Set runslow=FALSE to just load the saved result
runslow = TRUE
#####CHANGE THIS ACCORDINGLY #####
...
#######################################################
# Run the unconstrained DEC+J model
#######################################################
BioGeoBEARS_run_object = define_BioGeoBEARS_run()
BioGeoBEARS_run_object$trfn = trfn
BioGeoBEARS_run_object$geogfn = geogfn
...
# Set up DEC+J model
# Get the ML parameter values from the 2-parameter nested model above (DEC model)
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on example_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on example_unconstrained"
...
#######################################################
# Model weights of the two models
#######################################################
restable2 = restable
